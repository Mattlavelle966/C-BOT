...
Expect minor bugs or inefficiencies or inconsistencies is this was kina a rapid prototyping kinda thing, this build is mainly for testing core input hooks and replay accuracy really i just scrambled this together specifically `keyhook.c` but the other files show my learning process.
